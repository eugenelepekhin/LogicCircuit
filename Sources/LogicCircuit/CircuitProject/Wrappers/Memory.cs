...
namespace LogicCircuit {
	...
	internal partial struct MemoryData {
		...
		public static TableSnapshot<MemoryData> CreateTable(StoreSnapshot store) {
			TableSnapshot<MemoryData> table = new TableSnapshot<MemoryData>(store, "Memory"
				,MemoryIdField.Field
				,WritableField.Field
				,WriteOn1Field.Field
		...
		public static void Save(TableSnapshot<MemoryData> table, XmlElement root) {
		...
		public static void Load(TableSnapshot<MemoryData> table, XmlNodeList list, Action<RowId> register) {
			Dictionary<string, IFieldSerializer> field = new Dictionary<string, IFieldSerializer>();
			foreach(IField<MemoryData> f in table.Fields) {
