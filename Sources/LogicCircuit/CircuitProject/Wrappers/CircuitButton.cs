...
namespace LogicCircuit {
	...
	internal partial struct CircuitButtonData {
		...
		public static void Save(TableSnapshot<CircuitButtonData> table, XmlElement root) {
		...
		public static void Load(TableSnapshot<CircuitButtonData> table, XmlNodeList list, Action<RowId> register) {
			foreach(XmlElement node in list) {
				...
				foreach(XmlNode child in node.ChildNodes) {
					...
					if(c != null && c.NamespaceURI == node.NamespaceURI) {
						IFieldSerializer serializer = CircuitButtonData.FindField(c.LocalName, ref hintIndex);
						if (serializer != null) {
